...
function CommandDialog({
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange} {...props}>
      <Dialog.Portal>
        <Dialog.Backdrop className="data-[ending-style]:opacity-0 data-[starting-style]:opacity-0 fixed inset-0 z-50 bg-black/50 transition-opacity duration-150" />
        <Dialog.Popup className="data-[ending-style]:opacity-0 data-[starting-style]:opacity-0 fixed top-[20%] left-1/2 z-50 w-full max-w-lg -translate-x-1/2 overflow-hidden rounded-xl border shadow-lg transition-opacity duration-150">
          <Command
