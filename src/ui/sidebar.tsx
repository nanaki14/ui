    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Collapsible: icon (variant-aware)
          variant === 'floating' || variant === 'inset'
            ? 'group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4)))]'
            : 'group-data-[collapsible=icon]:w-(--sidebar-width-icon)',
        )}
      />
      {/* Sidebar container (fixed positioned shell) */}
      <div
        ...
        className={cn(
          ...
          // Transition
          'transition-[left,right,width] duration-200 ease-out-quad',
          // Side: left
        ...
        {...props}
      >
        {/* Sidebar inner (actual content surface) */}
        <div
          data-sidebar="sidebar"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        // Cursor per side + collapsed state
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Scrollbar
        'no-scrollbar',
        // Collapsible: icon (hide overflow)
    ...
    props: mergeProps<'div'>(
      {
        className: cn(
          ...
          // Transition
          'transition-[margin,opacity] duration-200 ease-out-quad',
          // Focus
    ...
    props: mergeProps<'button'>(
      {
        className: cn(
          ...
          // Collapsible: icon (hide)
          'group-data-[collapsible=icon]:hidden',
          // Peer (menu-button) based offset + hover color
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Collapsible: icon (hide)
        'group-data-[collapsible=icon]:hidden',
        // Peer (menu-button) based offset + color
        'peer-hover/menu-button:text-sidebar-accent-foreground',
        'peer-data-active/menu-button:text-sidebar-accent-foreground',
        'peer-data-[size=default]/menu-button:top-1.5',
        'peer-data-[size=lg]/menu-button:top-2.5',
    ...
    props: mergeProps<'a'>(
      {
        className: cn(
          ...
          // Icon / text truncate
          '[&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground [&>span:last-child]:truncate',
          className,
        ),
      },
      props,
